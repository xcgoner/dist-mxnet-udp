...
def DownsampleFactory(data, ch_3x3, name, attr):
    ...
    # pool
    pool = mx.symbol.Pooling(data=data, name=name+'_pool',kernel=(3, 3), stride=(2, 2), pad=(1, 1), pool_type='max',pooling_convention='full', attr=attr)
    # concat
...
#def get_symbol():
    ...
    if height <= 28:
        ...
        pool1 = mx.symbol.Pooling(data=conv1, kernel=(3, 3), stride=(2, 2), name='pool_1', pool_type='max',pooling_convention='full',)
        # stage 2
        ...
        pool2 = mx.symbol.Pooling(data=conv2, kernel=(3, 3), stride=(2, 2), name='pool_2', pool_type='max',pooling_convention='full',)
        # stage 2
        ...
        # global avg pooling
        pool = mx.symbol.Pooling(data=in5b, kernel=(7, 7), stride=(1, 1), name="global_pool", pooling_convention='full',pool_type='avg')
